...
namespace ZLGCAN
{
    ...
    {
        public ushort hw_Version; // 硬件版本
        public ushort fw_Version; // 固件版本
        public ushort dr_Version; // 驱动版本
        public ushort in_Version; // 动态库版本
    ...
    public class Define
    {
        ...
        public const int ZCAN_UCANFD_400U = 201;
        public const int ZCAN_UCAN_401U = 200;
    ...
    public class Method
    {
        //@-"D:\work\c_and\Usb_Can_Dll\Debug\Usb_Can_Dll.dll"
        ...
        [DllImport("zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_GetDeviceInf(IntPtr channel_handle, IntPtr pInfo);
